...
const BoredApesComponent = () => {
  return (
    <div
      className="relative bg-cover bg-center text-white h-screen flex flex-col items-center justify-center  "
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        {/* Profile Image */}
        <div className="rounded-[100px] border-4 border-[#FD43D8]  bg-black w-[164px] h-[158px]">
          <img
            src={pc1}
            alt="Bored Ape"
        ...
        {/* Description */}
        <p className="text-center mt-2 max-w-2xl px-4">
        ...
        {/* Stats Section */}
        <div className="flex mt-6 space-x-24 bg-black bg-opacity-5 backdrop-blur-md p-4 rounded-lg shadow-md">
